...
execute as @s[tag=wasd.north] run summon minecraft:item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:golden_apple",Count:1b,tag:{display:{Name:'{"text":"Rotten Apple","color":"gold","italic":false}',Lore:['{"text":"Drop this on a horse to turn it into a Zombie Horse.","color":"white","italic":false}','{"text":"Not great for eating!","color":"white","italic":false}']},CustomModelData:6370002,wasd_apple:1b,wasd_apple_type:3b}}}
