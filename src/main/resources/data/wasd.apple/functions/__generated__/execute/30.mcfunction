...
execute as @s[tag=wasd.north] run summon minecraft:item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:golden_apple",Count:1b,tag:{display:{Name:'{"text":"Spectator Apple","italic":false}',Lore:['{"text":"Eat for 10 seconds of spectator mode.","color":"white","italic":false}','{"text":"Returns you to your original position.","color":"white","italic":false}']},CustomModelData:6370001,wasd_apple:1b,wasd_apple_type:1b}}}
