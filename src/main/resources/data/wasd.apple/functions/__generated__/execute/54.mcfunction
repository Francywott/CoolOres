...
execute as @s[tag=wasd.north] run summon minecraft:item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:golden_apple",Count:1b,tag:{display:{Name:'{"text":"Crying Obsidian Apple","italic":false}',Lore:['{"text":"Converts nearby lava into obsidian temporarily.","color":"white","italic":false}']},CustomModelData:6370005,wasd_apple:1b,wasd_apple_type:6b}}}
