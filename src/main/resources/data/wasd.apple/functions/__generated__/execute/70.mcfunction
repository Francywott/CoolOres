...
execute as @s[tag=wasd.north] run summon minecraft:item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:golden_apple",Count:1b,tag:{display:{Name:'{"text":"Nether Apple","italic":false}',Lore:['{"text":"Leave a trail of fire behind you. Gives fire resistance.","color":"white","italic":false}']},CustomModelData:6370010,wasd_apple:1b,wasd_apple_type:11b}}}
